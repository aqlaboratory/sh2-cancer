...
DistributeDefinitions[SequenceToPositionBasedFeatures];
...
DistributeDefinitions[SequenceToResidueBasedFeatures];
...
DistributeDefinitions[ContactMapToConnectedPositions];
