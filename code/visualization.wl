...
blocks=MapThread[SetAlphaChannel[ImageResize[#1,{Scaled[1],Max[#2*ImageDimensions[#1][[2]],1]}],If[OptionValue[Opacity],Min[(#2+OptionValue[OpacityShift])/heightMax,1],1]]&,{archetypes,#}]&/@heights;
